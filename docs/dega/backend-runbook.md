...
The MockDEGA on Sepolia reports **18**, so the panel renders the 50000000 base-unit fee as
`0.00000000005 $DEGA`. If the contract cannot be read, the UI shows base units with
