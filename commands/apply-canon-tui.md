...
Package: `canon-tui` from `DEGAorg/canon` (main branch)

```
git+https://github.com/DEGAorg/canon.git@main
```
...
```bash
uv tool install "canon-tui @ git+https://github.com/DEGAorg/canon.git@main" --force --reinstall --quiet
```
...
```
https://raw.githubusercontent.com/DEGAorg/canon/main/commands/apply-canon-tui.md
```
...
Installed from: DEGAorg/canon@main
